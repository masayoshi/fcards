...
#== Route Map
# Generated on 09 Sep 2012 16:26
#
...
#                study_deck GET    /decks/:id/study(.:format)                                              decks#study
#      again_this_card_deck GET    /decks/:id/again_current_card_and_fetch_next(.:format)                  decks#again_current_card_and_fetch_next
#   tommorow_this_card_deck GET    /decks/:id/study_tommorow_current_card_and_fetch_next(.:format)         decks#study_tommorow_current_card_and_fetch_next
# three_days_this_card_deck GET    /decks/:id/study_three_days_later_current_card_and_fetch_next(.:format) decks#study_three_days_later_current_card_and_fetch_next
#     a_week_this_card_deck GET    /decks/:id/study_a_week_later_current_card_and_fetch_next(.:format)     decks#study_a_week_later_current_card_and_fetch_next
#    a_month_this_card_deck GET    /decks/:id/study_a_month_later_current_card_and_fetch_next(.:format)    decks#study_a_month_later_current_card_and_fetch_next
#      never_this_card_deck GET    /decks/:id/never_study_current_card_and_fetch_next(.:format)            decks#never_study_current_card_and_fetch_next
